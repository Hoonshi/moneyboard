  ...
  return (
    <div className="max-w-lg space-y-5">
      ...
      <div className="border border-gray-200 rounded-lg p-3">
        <span className="text-xs font-mono text-gray-400 uppercase tracking-wider">프로필</span>
      ...
      <div className="border border-gray-200 rounded-lg p-3">
        ...
        <div className="mt-2 space-y-1.5">
          {CATEGORIES.map((cat) => (
            <div key={cat.name} className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-gray-50">
      ...
      <div className="border border-gray-200 rounded-lg p-3">
        ...
        <div className="mt-2 space-y-1.5">
          {RECURRING.map((item) => (
            <div key={item.name} className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-gray-50">
      ...
      {/* Account */}
      <div className="border border-gray-200 rounded-lg p-3">
        <span className="text-xs font-mono text-gray-400 uppercase tracking-wider">계정</span>
        <div className="mt-2 space-y-2">
          ...
          <div className="border-t border-gray-100 pt-2">
            <span className="text-xs text-red-400 cursor-pointer">로그아웃</span>
          </div>
        </div>
      </div>
    </div>
